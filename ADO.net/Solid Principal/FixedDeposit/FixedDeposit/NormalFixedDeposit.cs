...
{
    class NormalFixedDeposit:IFixedDeposit
    {
        private int _accno;
        ...
        public NormalFixedDeposit(int accno, string name, double principal, int years, FestivalType fest)
        {
            this._accno = accno;
            this._name = name;
        ...
        double IFixedDeposit.CalculateFixedDeposit()
        {
           ...
           this._amt = ((this._principal*this._years * temp)/100.0);
            return this._amt;
