...
getaddressUrl:string="http://localhost:57364/api/v1/tenent/{"+this.tenentId+"}/users/{"+this.userId+"}/contact/{"
 getaddress(id:string):Observable<Address[]>{
   return this.http.get<Address[]>(this.getaddressUrl+id+"}/address")
 }
...
editContact(id:any,val:any){
 ...
 postaddressUrl:string="http://localhost:57364/api/v1/tenent/{"+this.tenentId+"}/users/{"+this.userId+"}/contact/{"
 AddAddress(id:any,val:Address){
   return this.http.post(this.postaddressUrl+id+"}/address/register",val);
 }


 editaddressUrl:string="http://localhost:57364/api/v1/tenent/{"+this.tenentId+"}/users/{"+this.userId+"}/contact/{";
editaddress(cid:any,aid:any,val:any){
  return this.http.put(this.editaddressUrl+cid+"}/address/{"+aid+"}/edit",val);
}

deleteaddressUrl:string="http://localhost:57364/api/v1/tenent/{"+this.tenentId+"}/users/{"+this.userId+"}/contact/{";
